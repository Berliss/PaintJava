...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    public VentanaPrincipal() {
        ...
        menuDeFiguras.setVisible(false);
    ...
    private void initComponents() {
        ...
        menuDeFiguras = new javax.swing.JMenu();
        ...
        btn22.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/lapiz (1).png"))); // NOI18N
        ...
        jToggleButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/imagen (1).png"))); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(comboGrosor, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jLabel5, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(radioButtonFiguraRellena, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(lblFigura, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(15, 15, 15)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(btn20, javax.swing.GroupLayout.PREFERRED_SIZE, 54, Short.MAX_VALUE)
                            .addComponent(btn22, javax.swing.GroupLayout.PREFERRED_SIZE, 54, Short.MAX_VALUE))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(panelColor1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(panelColor2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(comboGrosor, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(radioButtonFiguraRellena))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(btn22, javax.swing.GroupLayout.DEFAULT_SIZE, 39, Short.MAX_VALUE)
                                    .addComponent(btn24, javax.swing.GroupLayout.DEFAULT_SIZE, 39, Short.MAX_VALUE)
        ...
        menuDeFiguras.setText("Figuras2");
        jMenuBar1.add(menuDeFiguras);
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        ...
        if (bimg != null) {
            panelDeDibujo.getFiguras().add(new Imagen(new Point(0, 0), bimg.getWidth(), bimg.getHeight(), Color.BLACK, bimg));
    ...
    private javax.swing.JMenu menuDeFiguras;
    ...
    private void figuraADibujarseEnCadaBoton(Graphics g, JToggleButton btn) {
        ...
        figuraActual = figuraADibujarse(
                btn.getText(), puntoInicio,
                anchura, altura,
                colorPrimario, true);
    ...
    public Figura figuraADibujarse(String figuraSeleccionada, Point puntoActual,
            int anchura, int altura, Color colorPrimario, boolean dibujarEnBotones) {
        ...
        switch (figuraSeleccionada) {
            ...
            case "Linea":
                if (dibujarEnBotones) {
                    figuraActual = new LineaRedimensionable(
                            new Point((anchura * 4) / 6, (altura * 4) / 6),
                            new Point((anchura * 4), (altura * 4)),
                            colorPrimario);
                } else {
    ...
    private void crearMenuItems() {
        ...
        for (String nombreDeFigura : figurasDisponibles) {
            ...
            menuDeFiguras.add(menuItemActual);
    ...
    private int guardarImagen() {
        ...
        if (resultado == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                BufferedImage bi = new BufferedImage(panelDeDibujo.getWidth(), panelDeDibujo.getHeight(), BufferedImage.TYPE_INT_ARGB);
    ...
    private void preguntarAntesDeCerrar() {
        ...
        if (!panelDeDibujo.getFiguras().isEmpty()) {
            ...
            int resultado = JOptionPane.showConfirmDialog(
                    this, "Deseas guardar los cambios ?",
                    "Dibujante - " + this.getTitle(),
                    JOptionPane.YES_NO_CANCEL_OPTION);
    ...
    public Color obtenerColorEn(Point puntoActual) {
        BufferedImage image = new BufferedImage(
                panelDeDibujo.getWidth(),
                panelDeDibujo.getHeight(),
